    ...
    <>
      ...
      <section className="bg-mist px-5 py-24 sm:px-8 lg:py-30">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          ...
          <div className="relative min-h-[460px] overflow-hidden rounded-[9px]"><img src="/images/services/transferts-bs.jpeg" alt="Véhicule TAXI-LUX pour un transfert Brussels Airport" className="absolute inset-0 h-full w-full object-cover" /><div className="absolute right-5 bottom-5 left-5 rounded-[8px] border border-white/60 bg-white/85 p-5 shadow-card backdrop-blur-xl"><div className="flex items-center gap-4"><span className="icon-disc"><FontAwesomeIcon icon={faPlane} /></span><div><p className="font-bold text-navy">Brussels Airport</p><p className="mt-1 text-xs text-muted">Transferts planifiés vers et depuis l’aéroport</p></div></div></div></div>
        </div>
      </section>

      <section className="px-5 py-24 sm:px-8 lg:py-30">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          <div className="relative min-h-[460px] overflow-hidden rounded-[9px]"><img src="/images/services/taxi-arrivees.jpeg" alt="Prise en charge TAXI-LUX à proximité des arrivées" className="absolute inset-0 h-full w-full object-cover" /><div className="absolute top-5 left-5 rounded-[7px] border border-white/60 bg-white/85 px-5 py-4 text-navy shadow-card backdrop-blur-xl"><FontAwesomeIcon icon={faLocationDot} className="mr-3 text-brand-red" /><span className="text-xs font-bold">Prise en charge dans les emplacements autorisés</span></div></div>
